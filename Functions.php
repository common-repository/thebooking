...
function localize_backend_script()
{
    return apply_filters('tbk_backend_js_data_common', [
        ...
        'timezoneList'        => \VSHM_Framework\Tools::timezone_list(),
        ...
        'userPrefs'           => (get_user_option('tbkgUserPrefs') ?: []) + [
                ...
                'reservationsTableShowPast'    => TRUE,
                'reservationsTableGroupByDate' => TRUE,
                'reservationsTableShowFilters' => TRUE,
            ],
        'statuses'            => [
            ...
            ValueTypes\Status::DECLINED  => __('Declined', 'thebooking'),
